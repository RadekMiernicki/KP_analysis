...
def main():
    to_csv= CreateCSV.to_csv
    data = ImportData.monthly()
    monthly_by_channel = data.pivot_table(index=['Date'], 
                            values = ['RCH', 'AMR', 'SHR'], 
                            columns = ['Channel'])
    monthly_by_channel_rch = monthly_by_channel['RCH']
    monthly_by_channel_amr = monthly_by_channel['AMR']
    monthly_by_channel_shr = monthly_by_channel['SHR']

    to_csv(monthly_by_channel, 'monthly_by_channel')
    to_csv(monthly_by_channel_rch, 'monthly_by_channel_rch')
    to_csv(monthly_by_channel_amr, 'monthly_by_channel_amr')
    to_csv(monthly_by_channel_shr, 'monthly_by_channel_shr')
    to_csv(data, 'data')
